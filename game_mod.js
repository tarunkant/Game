...
function level2() {
  ...
  var game2 = new Phaser.Game(1120, 580, Phaser.AUTO, '', { preload: preload_2, create: create_2, update: update_2, render: render_2 });
  ...
  function preload_2() {
      ...
      game2.load.image('popup', 'images/chall_screen1.png');
      game2.load.image('close', 'images/closeButton.png');
      game2.load.image('submit', 'images/submit.png');
  ...
  function create_2() {
      ...
      popup = game2.add.sprite(game2.world.centerX + 200-50, game2.world.centerY, 'popup');
      popup.alpha = 1;
      ...
      var closeButton = game2.make.sprite(pw, -ph, 'close');
      ...
      //  And click the close button to close it down again
      var submitButton = game2.make.sprite(pw-350-50, -ph+725, 'submit');
      ...
      game2.add.plugin(PhaserInput.Plugin);
      Flag = game2.add.inputField(350+185+150, 400+150-75, {
      font: '18px Arial',
      fill: '#212121',
      fontWeight: 'bold',
      width: 150,
...
var game = new Phaser.Game(1120, 580, Phaser.AUTO, '', { preload: preload, create: create, update: update, render: render });
...
function create() {
    ...
    game.add.tileSprite(0, 0, 1280, 780, 'house');  // For the maps
    ...
    popup = game.add.sprite(game.world.centerX + 150, game.world.centerY - 75, 'popup');
    popup.alpha = 1;
    popup.anchor.set(0.5);
    popup.inputEnabled = true;
    ...
    //  And click the close button to close it down again
    var submitButton = game.make.sprite(pw-350, -ph+675, 'submit');
    submitButton.inputEnabled = true;
    submitButton.input.priorityID = 2;
    submitButton.input.useHandCursor = true;
    submitButton.events.onInputDown.add(validateFlag, this);
    ...
    Flag = game.add.inputField(350+250, 400+50, {
    font: '18px Arial',
    fill: '#212121',
    fontWeight: 'bold',
    width: 150,
...
function display_chall_details() {
    ...
    var challenge_text = 'Title: ' + challenge_dict['title'] + '\n' + 'Description: ' +
      ...
      '\n' + 'Category: ' + challenge_dict['category'] + '\n' + 'Points: ' +
        challenge_dict['value'] + '\n' + 'Link to file available in website';

    chal_text = cur_game.add.text(cur_game.world.width/3+75, cur_game.world.height/2-200, challenge_text, { font: "23px italic", fill: "#000000", align: "left" });
}
...
function validateFlag() {
  ...
  console.log(flag_dict['flag'], Flag.value);
    if(flag_dict['flag'] === Flag.value) {
      checkFlag = true;
      alert('Correct! You won ' + challenge_dict['value'] + ' points!');
    }
...
function level3() {
  ...
  function create_3() {
      ...
      var map = game3.add.tileSprite(game3.world.height/2-200, game3.world.width/2-400, 400, 'land');  // For the maps
